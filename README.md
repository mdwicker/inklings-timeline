...
This is still very early-stage and experimental. I'm fairly new to programming,
...
## Limitations (for now)
- Scrolling and zooming is still a bit glitchy and unintuitive, at least on some devices.
- Data structuring isn't perfect--it's a work in progress
- No filtering panel
- Quite data heavy and hard to parse when zoomed way out

## Roadmap
- Add icon to indicate group visibility
- Clean up data structuring
