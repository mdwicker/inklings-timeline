...
describe('getRangeSections', () => {
    ...
    test('one window, two sections', () => {
        const sections = getRangeSections({
            totalRange: { start: new Date("1900-01-01"), end: new Date("1900-01-03") },
    ...
    test('two windows, four sections', () => {
        const sections = getRangeSections({
            totalRange: { start: new Date("1900-01-01"), end: new Date("1900-01-05") },
            windowSize: ONEDAYINMS * 2,
            sectionsPerWindow: 2
        });
    ...
    test('ten one-day sections', () => {
        ...
        const sections = getRangeSections({ totalRange: range, windowSize, sectionsPerWindow });
        expect(sections).toStrictEqual([
            {
                start: new Date("1900-01-01"),
                end: new Date("1900-01-02")
    ...
    test('sections go past range end', () => {
        const sections = getRangeSections({
            totalRange: { start: new Date("1900-01-01"), end: new Date("1900-01-11") },
    ...
    test('range zero', () => {
        const sections = getRangeSections({
            totalRange: { start: new Date("1900-01-01"), end: new Date("1900-01-01") },
            windowSize: ONEDAYINMS,
            sectionsPerWindow: 1
        });
    ...
    test('range start after range end', () => {
        const sections = getRangeSections({
            totalRange: { start: new Date("1900-01-02"), end: new Date("1900-01-01") },
            windowSize: ONEDAYINMS,
            sectionsPerWindow: 1
        });
    ...
    test('zero sections/window', () => {
        expect(() => {
            getRangeSections({
                totalRange: { start: new Date("1900-01-01"), end: new Date("1900-01-011") },
                windowSize: ONEDAYINMS,
                sectionsPerWindow: 0
            });
