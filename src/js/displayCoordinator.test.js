...
describe('LOD manager', () => {
    ...
    test('extended itemset, middle zoom level', () => {
        ...
        */
        ...
        })).toStrictEqual(new Set([6, 7, 8, 10, 13, 16, 19, 20, 21, 22, 23, 24, 25, 27, 28, 29, 30]));
    });
